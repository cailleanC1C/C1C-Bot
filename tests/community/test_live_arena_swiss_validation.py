...
def test_full_validator_rejects_non_adjacent_records():
    q1 = q1_truth()
    q2 = [
        finalized(2, 1, 1, 3, 2, 0),
        finalized(2, 2, 2, 4, 2, 0),
    ]
    # After Q2, players 1/2 are 2-0 and 3/4 are 0-2. Crossing those groups in Q3 is illegal.
    q3 = [preview(3, 1, 1, 4), preview(3, 2, 2, 3)]
